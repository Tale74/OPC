...
| Persistence/data platform | `core/database/**`, Drift generated code | Schema, migrations, repair, recovery, database identity and tables; fresh databases seed the 29 system-required KATALOG categories but no business articles | Drift/SQLite, filesystem/test selectors |
