...
| Post-zero PREDMET lifecycle/referential design | `docs/OPC_POST_ZERO_PREDMET_LIFECYCLE_REFERENTIAL_DESIGN.md` | Referential audit, dependent-data matrix, current source/tests and migration policy | DESIGN PASS; RI-1 characterization is next, production/data mutation remains unauthorized. |
