...
| Windows real runtime / canonical closure | `docs/OPC_WINDOWS_VISUAL_REPAIRED_DB_FINAL_CLOSURE_REPORT.md` (supersedes `docs/OPC_WINDOWS_REAL_RUNTIME_CANONICAL_CLOSURE_REPORT.md`) | Installed OPC.exe Computer Use observations, rollback-backed repaired-state startup proof, active DB hash evidence and repaired-copy proof | CURRENT WINDOWS GATE EVIDENCE; startup/PREDMET loading pass, concrete visual/SCENARIO/LISTA proof and canonical dedup remain deferred. |
