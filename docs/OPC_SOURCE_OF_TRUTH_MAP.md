...
| Windows real runtime / canonical closure | `docs/OPC_WINDOWS_REAL_RUNTIME_CANONICAL_CLOSURE_REPORT.md` | Installed OPC.exe Computer Use observations, active DB copy/hash evidence and repaired-copy proof | CURRENT WINDOWS GATE EVIDENCE; installed cold/reopen pass, repaired-copy UI injection and canonical dedup remain deferred. |
