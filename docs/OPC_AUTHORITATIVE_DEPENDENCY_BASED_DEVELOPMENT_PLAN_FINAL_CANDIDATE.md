# OPC — authoritative dependency-based development plan — final owner-approval candidate

**Status:** FINAL CANDIDATE – OWNER APPROVAL REQUIRED
...
**Preparation base SHA:** `eab28232dd1a791ecd0c24ee33b7f93a34f13797`
**Preparation branch:** `task/OPC-GATE-0-FINAL-PLAN-OWNER-APPROVAL`
**Datum final-candidate pripreme:** 26. jul 2026.
...
- owner approval ovog final-candidate dokumenta;
...
1. Odobrenje ovog final-candidate sadržaja, Decision Authority Matrix-a i dependency reda.

### Posle Phase 1 audita, pre relevantne implementacije

2. `ZATVOREN`/`ZAVRŠEN` i historical-lock lifecycle, uključujući eventualni correction/reopen izuzetak.
3. Tretman istorijski auto-završenih PREDMETA.
4. Poslovna IRiU keep/remove/archive/merge pravila.
5. Owner runtime acceptance za Codex-definisane Windows startup i Android PARTE tehničke targete.

### Pre odgovarajućih funkcionalnih/product taskova

6. PDF RAČUN toggle migration default za postojeće instalacije.
7. Poslovni sadržaj i PDF/DOCX scope NALOGA CVEĆARI.
8. Globalni trenutak aktivacije EUR režima i eventualna owner odluka o konverziji tada otvorenih PREDMETA.
9. OPC Srbija app identity i update kanal.
10. Multilingual product/business identity.
11. Publisher i signing-key custody/transfer model.
