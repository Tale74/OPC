...
- Release-risk timing/parity: current-tip Windows startup/login/exit acceptance is closed with five owner-authorized login transitions, five normal exits and three relaunch cycles. Android RR-011 physical parity is blocked by the reproduced disposable-lane schema initialization defect and retains exactly one bounded correction/re-acceptance successor.
