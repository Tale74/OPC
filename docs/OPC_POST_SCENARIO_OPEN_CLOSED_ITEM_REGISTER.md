...
- Release-risk timing/parity: current-tip Windows startup/login/exit acceptance is closed with five owner-authorized login transitions, five normal exits and three relaunch cycles; Android physical parity remains an inconclusive successor.
