...
The singleton prerequisite and RR-005 correction are closed by full acceptance. RR-010 can follow independently on a disposable lane, while RR-008 and RR-011 remain acceptance successors and are not reasons to alter current source in this wave.
