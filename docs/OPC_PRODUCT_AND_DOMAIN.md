...
| IRiU order | `ordered OSNOVNI PAKET → ordered applied SCENARIO PAKET → manual/unpredicted items` | `docs/OPC_PURPOSE_AND_ANTI_DRIFT_MANIFEST.md`, `docs/OPC_TECHNICAL_EXECUTION_STANDARD.md` | SCENARIO/Tier 2 contract and ordering tests |
