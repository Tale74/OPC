...
| `OPC_v1_CODEX_RULES.md` | `SOURCE/PROJECT_DOCS` and control copy | YES AS SUMMARY | SUPPORTING | SUPERSEDED BY PUBLIC DOC | YES | Project-specific task controls now live in `OPC_DEVELOPMENT.md` and the manifest; reusable method is external Layer 3. | `docs/OPC_DEVELOPMENT.md`, `docs/OPC_PURPOSE_AND_ANTI_DRIFT_MANIFEST.md` |
