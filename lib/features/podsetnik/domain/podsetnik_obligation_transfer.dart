...
class PodsetnikObligationTransferState {
  ...
  factory PodsetnikObligationTransferState.fromJsonMap(
    ...
    final obligationText = map['obligationText'];
    ...
    if (completed is! bool ||
        ...
        (obligationText != null && obligationText is! String)) {
    ...
    return PodsetnikObligationTransferState(
      ...
      obligationText: obligationText is String
          ? obligationText.trim()
          : null,
    );
  }
  ...
  Map<String, dynamic> toJsonMap() => <String, dynamic>{
    ...
    if (obligationText != null && obligationText!.isNotEmpty)
